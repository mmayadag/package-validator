import type { OutdatedDependencies, OutdatedDependency, RepositoryRef } from '@package-validator/contracts';

/** HTML and text renderings of a report; produced only when an email is sent. */
